...
function gotPoses(results)
{
  if(results.length > 0)
  {
      rightWrist[0] = results[0].pose.rightWrist.x;
      rightWrist[1] = results[0].pose.rightWrist.y;
...
function draw(){
  ...
  console.log(rightScore, rightWrist)

  if(rightScore > 0.2)
  {
    fill('red');
    circle(rightWrist[0], rightWrist[1], 30)
  }
